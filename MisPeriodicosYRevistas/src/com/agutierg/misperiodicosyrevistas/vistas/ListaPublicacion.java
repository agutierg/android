...
import com.agutierg.misperiodicosyrevistas.dto.Publicacion;
import com.agutierg.misperiodicosyrevistas.util.LazyAdapter;
...
public class ListaPublicacion extends Activity {
	...
	private LinearLayout llListPubli;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		llListPubli = (LinearLayout) findViewById(R.id.llListPubli);

		// Añadirle la adView
		llListPubli.addView(adView);
