package com.agutierg.peterlaanguila.vistas;

import com.agutierg.peterlaanguila.R;
import com.agutierg.peterlaanguila.constants.ConstantesParametros;
		...
		builder.setPositiveButton(ConstantesParametros.MENU_CONTEX_OK,
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						startActivity(new Intent(
								Intent.ACTION_VIEW,
								Uri.parse("https://play.google.com/store/apps/details?id=com.agutierg.peterlaanguila&feature=search_result#?t=W251bGwsMSwxLDEsImNvbS5hZ3V0aWVyZy5wZXRlcmxhYW5ndWlsYSJd")));
					}
				});
